...
class HabitacionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('habitacions')->insert([
            ...
            ['numero_habitacion' => 104, 'tipo' => 'Familiar', 'precio' => 150.00, 'descripcion' => 'Habitación familiar con dos camas individuales y una matrimonial', 'disponibilidad' => true, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['numero_habitacion' => 108, 'tipo' => 'Familiar', 'precio' => 160.00, 'descripcion' => 'Habitación familiar con tres camas individuales', 'disponibilidad' => true, 'created_at' => now(), 'updated_at' => now()],
