    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row gap-4">
            <div class="md:w-1/4 bg-gray-900 rounded-lg p-4 h-screen flex flex-col justify-between">
                <ul class="list-none">
                    <li><a class="text-white nav-link font-bold text-lg" href="{{ route('movimientos') }}">Movimientos</a></li>
                    <li><a class="text-white nav-link font-bold text-lg" href="{{ route('parking_day') }}">Ver Parking</a></li>
                </ul>            </div>
